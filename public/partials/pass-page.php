            ...
            <div class="wp-block-group__inner-container is-layout-constrained wp-block-group-is-layout-constrained">
                ...
                <?php if (!empty($summary['items'])) : ?>
                    <div class="wp-block-buttons is-layout-flex wp-block-buttons-is-layout-flex dlab-pass__continue">
                        <a class="wp-block-button__link has-dd-black-color has-dd-white-background-color has-text-color has-background has-link-color btn dlab-btn dlab-btn--ghost" href="<?php echo esc_url($listing_url); ?>">
